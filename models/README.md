...
The weights are not yet public. They will be released with the published paper (GitHub release and
Zenodo record, links to be added here). Until then, requests for the model file go to the corresponding
